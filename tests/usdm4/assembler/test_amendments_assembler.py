...
from src.usdm4.api.subject_enrollment import SubjectEnrollment
from src.usdm4.api.geographic_scope import GeographicScope
from src.usdm4.api.quantity_range import Quantity
...
class TestAmendmentsAssemblerInitialization:
    ...
    def test_init_with_valid_parameters(self, builder, errors):
        ...
        assert assembler.MODULE == "usdm4.assembler.amendments_assembler.AmenementsAssembler"
...
class TestAmendmentsAssemblerValidData:
    ...
    def test_execute_with_non_percentage_enrollment_unit(self, amendments_assembler):
        ...
        assert enrollment.quantity.unit is None  # Should be None for non-percentage units
    ...
    def test_execute_with_all_valid_reason_codes(self, amendments_assembler):
        ...
        for i, reason in enumerate(valid_reasons[:5]):  # Test first 5 to avoid too many iterations
...
class TestAmendmentsAssemblerEdgeCases:
    ...
    def test_execute_with_unicode_summary(self, amendments_assembler):
        ...
        unicode_summary = "Amendment with émojis 🧬💊 and special characters: àáâãäåæçèéêë"
        data = {
...
class TestAmendmentsAssemblerErrorHandling:
    ...
    def test_error_handling_with_exception_in_create_amendment(self, amendments_assembler, errors):
    ...
    def test_error_handling_with_exception_in_create_enrollment(self, amendments_assembler, errors):
...
class TestAmendmentsAssemblerBuilderIntegration:
    ...
    def test_builder_create_method_integration(self, amendments_assembler):
        ...
        if amendments_assembler.amendment is not None:
            amendment = amendments_assembler.amendment
            assert hasattr(amendment, 'id')  # Objects created by Builder should have IDs
...
class TestAmendmentsAssemblerStateManagement:
    ...
    def test_inheritance_from_base_assembler(self, amendments_assembler):
        ...
        assert amendments_assembler.MODULE == "usdm4.assembler.amendments_assembler.AmenementsAssembler"
...
class TestAmendmentsAssemblerAdditionalCoverage:
    ...
    def test_execute_with_whitespace_in_summary(self, amendments_assembler):
        ...
        if amendments_assembler.amendment is not None:
            assert amendments_assembler.amendment.summary == "  Amendment with leading and trailing spaces  "
    ...
    def test_execute_with_boolean_string_impact_values(self, amendments_assembler):
        ...
        if amendments_assembler.amendment is not None:
            # Test that amendment was created successfully
            assert amendments_assembler.amendment.summary == "Test with string boolean values"
    ...
    def test_execute_with_numeric_impact_values(self, amendments_assembler):
        ...
        if amendments_assembler.amendment is not None:
            # Test that amendment was created successfully
            assert amendments_assembler.amendment.summary == "Test with numeric impact values"
