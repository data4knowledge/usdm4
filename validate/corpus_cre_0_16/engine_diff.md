...
| Bucket | Rules |
|---|---:|
| `d4k_under_reporting` | 5 |
| `d4k_over_reporting` | 13 |
| `aligned` | 195 |
| `core_only_rule` | 1 |
...
### DDF00181  (under=230, over=0, exc=0, not_impl=0, aligned_fail=0, aligned_pass=4, total_files=234)
...
### DDF00025  (under=0, over=0, exc=0, not_impl=0, aligned_fail=103, aligned_pass=131, total_files=234)

_CORE id(s)_: CORE-000417
**DDF text.** A window must not be defined for an anchor timing (i.e., type is "Fixed Reference").
...
### DDF00229  (under=0, over=0, exc=0, not_impl=0, aligned_fail=222, aligned_pass=12, total_files=234)

_CORE id(s)_: CORE-001058
**DDF text.** A study design's study phase must be specified according to the extensible Trial Phase Response (C66737) SDTM codelist (e.g. an entry with a code or decode used from the codelist should be consistent with the full entry in the codelist).
...
### DDF00249  (under=0, over=0, exc=0, not_impl=0, aligned_fail=0, aligned_pass=234, total_files=234)
