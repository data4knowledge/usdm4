...
class Rule00004(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00004", RuleTemplate.ERROR, "If duration will vary (attribute durationWillVary is True) then a reason (attribute reasonDurationWillVary) must be given and vice versa.")
