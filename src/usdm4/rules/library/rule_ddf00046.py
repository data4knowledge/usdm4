...
class Rule00046(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00046", RuleTemplate.ERROR, "A timing must only be specified as being relative to/from a scheduled activity/decision instance that is defined within the same timeline as the timing.")
