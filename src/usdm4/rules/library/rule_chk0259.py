...
class RuleCHK0259(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("CHK0259", RuleTemplate.ERROR, "An interventional study design's sub types must be specified according to the extensible Trial Type Response (C66739) SDTM codelist (e.g. an entry with a code or decode used from the codelist should be consistent with the full entry in the codelist).")
