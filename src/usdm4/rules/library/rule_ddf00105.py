...
class Rule00105(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00105", RuleTemplate.ERROR, "A scheduled activity/decision instance must only reference an epoch that is defined within the same study design as the scheduled activity/decision instance.")
