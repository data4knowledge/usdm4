...
class Rule00020(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00020", RuleTemplate.ERROR, "If the reason for a study amendment is 'Other' then this must be specified (attribute reasonOther must be completed)")
