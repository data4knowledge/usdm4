...
class Rule00110(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00110", RuleTemplate.ERROR, "An eligibility criterion's category must be specified using the Category of Inclusion/Exclusion (C66797) SDTM codelist.")
