...
class Rule00114(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00114", RuleTemplate.ERROR, "If specified, the context of a condition must point to a valid instance in the activity or scheduled activity instance class.")
