...
class Rule00121(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00121", RuleTemplate.ERROR, "A study design's blinding schema must be specified according to the extensible Trial Blinding Schema Response (C66735) SDTM codelist (e.g. an entry with a code or decode used from the codelist should be consistent with the full entry in the codelist).")
