...
class Rule00074(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00074", RuleTemplate.ERROR, "If the intervention model indicates a single group design then only one intervention is expected. In all other cases more interventions are expected.")
