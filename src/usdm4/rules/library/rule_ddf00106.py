...
class Rule00106(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00106", RuleTemplate.ERROR, "A scheduled activity instance must only reference an encounter that is defined within the same study design as the scheduled activity instance.")
