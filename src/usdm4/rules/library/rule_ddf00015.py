...
class Rule00015(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00015", RuleTemplate.ERROR, "A study version's study phase must be specified according to the extensible Trial Phase Response (C66737) SDTM codelist (e.g. an entry with a code or decode used from the codelist should be consistent with the full entry in the codelist).")
