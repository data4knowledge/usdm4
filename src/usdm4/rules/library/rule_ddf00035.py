...
class Rule00035(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00035", RuleTemplate.ERROR, "Within a code system and corresponding version, a one-to-one relationship between code and decode is expected.")
