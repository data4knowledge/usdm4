...
class Rule00093(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00093", RuleTemplate.ERROR, "Date values associated to a study version must be unique regarding the combination of type and geographic scopes of the date.")
