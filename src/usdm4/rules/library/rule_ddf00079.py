...
class Rule00079(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00079", RuleTemplate.ERROR, "If a synonym is specified then it is not expected to be equal to the name of the biomedical concept (case insensitive).")
