...
class Rule00109(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00109", RuleTemplate.ERROR, "A study element must only reference study interventions that are defined within the same study design as the study element.")
