...
class Rule00026(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00026", RuleTemplate.ERROR, "A scheduled activity instance must not point (via the \"timeline\" relationship) to the timeline in which it is specified.")
