...
class Rule00129(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00129", RuleTemplate.ERROR, "A study intervention's product designation must be specified using the product designation (C207418) DDF codelist.")
