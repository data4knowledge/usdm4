...
class Rule00050(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00050", RuleTemplate.ERROR, "A study arm must only reference study populations or cohorts that are defined within the same study design as the study arm.")
