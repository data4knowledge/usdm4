...
class Rule00113(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00113", RuleTemplate.ERROR, "An agent administration's frequency must be specified according to the extensible Frequency (C71113) SDTM codelist (e.g. an entry with a code or decode used from the codelist should be consistent with the full entry in the codelist).")
