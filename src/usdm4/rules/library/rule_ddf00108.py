...
class Rule00108(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00108", RuleTemplate.ERROR, "There must be at least one exit defined for each timeline (i.e., at least one instance of StudyTimelineExit linked via the 'exits' relationship).")
