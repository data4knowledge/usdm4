...
class Rule00036(RuleTemplate):
    ...
    def __init__(self):
        super().__init__("DDF00036", RuleTemplate.ERROR, "If timing type is \"Fixed Reference\" then the corresponding attribute relativeToFrom must be filled with \"Start to Start\".")
